        ...
        **kwargs,
        ...
        if self.problem_type == 'regression':
            ...
            if llm_loss is not None and labels is not None:
                ...
                #print(token_losses.shape, self.normalized_weights[:gen_tok].unsqueeze(0).shape, gen_tok                    #print(token_losses[0])
                    #print(kkk)
            ...
            pooled_logits = self.score(hidden_states)  # Mean pooling over the last n tokens
            if llm_loss is not None and labels is not None:
